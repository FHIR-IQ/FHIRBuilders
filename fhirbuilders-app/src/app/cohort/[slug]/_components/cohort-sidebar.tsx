...
const NAV = [
  ...
  { label: "Session 4", href: "/session-4", icon: BookOpen },
  { label: "S4 Study", href: "/session-4/learn", icon: GraduationCap },
  { label: "Session 5", href: "/session-5", icon: BookOpen },
  { label: "S5 Study", href: "/session-5/learn", icon: GraduationCap },

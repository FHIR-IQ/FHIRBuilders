...
const COMMON_RESOURCES = [
  ...
  {
    name: "Observation",
    description: "Measurements and findings (requires: status, code; coded with LOINC)",
    icon: Activity,
  ...
  {
    name: "Condition",
    description: "Diagnoses and problems (requires: subject; coded with SNOMED CT / ICD-10)",
    icon: Stethoscope,
  ...
  },
  {
    ...
    description: "Prescriptions and orders (requires: status, intent, medication, subject; coded with RxNorm)",
    icon: Pill,
  ...
  {
    name: "Encounter",
    description: "Healthcare visits and interactions (requires: status, class)",
    icon: Building2,
